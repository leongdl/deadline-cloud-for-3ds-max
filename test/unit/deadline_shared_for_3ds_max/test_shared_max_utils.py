...
def test_submitter_utilities_import():
    """Test that submitter utilities can still import the shared functions."""
    try:
        from deadline.max_submitter.utilities.max_utils import (
            get_render_elements,
            validate_render_element_paths,
            get_render_elements_output_directories,
        )
...
def test_purify_render_element_name():
    ...
    assert purify_render_element_name("Name<>:\"|\?*/\\") == "Name_________"
...
def test_validate_render_element_configuration():
    ...
    settings = {"ignore_render_elements_by_name": ["Element1", "NonExistent"]}
